...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    for point_x in 0..size_x {
        for point_y in 0..size_y {
            let value: LatticeElement<u32> = LatticeElement(rng.gen());
...
fn still_image(mut matrix: MatrixImage<LatticeElement<u32>>) -> Result<MatrixImage<LatticeElement<u32>>, Box<dyn Error>> {
